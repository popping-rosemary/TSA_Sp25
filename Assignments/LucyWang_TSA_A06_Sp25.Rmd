...
```{r}
# Simulate SARIMA(0,0,1)(1,0,0)[12] model
set.seed(123)  # For reproducibility
simulated_data <- sim_sarima(n = 200, ar = 0.8, ma = 0.5, sar = 0.8, sma = 0, s = 12)

# Convert to time series object
ts_data <- ts(simulated_data, frequency = 12, start = c(2000, 1))
