...
```{r Q1 Renewable Energy Production Plots}
...
```{r Q1 Hydroelectric Consumption Plots}
...
```{r Q5 Renewable plots}
Renewable_detrend_acf <- plot_acf_pacf(Renewable_linear_trend, 1)[[1]]  # Ensure it's a ggplot
Renewable_detrend_pacf <- plot_acf_pacf(Renewable_linear_trend, 1)[[2]]  # Ensure it's a ggplot
